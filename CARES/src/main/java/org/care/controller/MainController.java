...
public class MainController {
	...
	/*
	 * @Inject private ListArticleService articleService;
	 */
	...
	public String mainPage(BoardDTO bdto,StoreDTO dto, Model model) throws Exception {
		 ...
		 * model.addAttribute("boardTop", boardTop); List<BoardPicInfo>
		 * boardPic=articleService.getBoardPic(boardTop); model.addAttribute("boardPic",
		 * boardPic); System.out.println("boardPic="+boardPic);
		 */
		return "main/index";
	}
